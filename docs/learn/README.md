...
| 5 | The Debt Mountain | docs/cycles/05-debt-supercycle.md (Atlas 0.1, L15) | https://claude.ai/code/artifact/5526aa4b-7612-4b35-8b89-dd5122670179 | docs/learn/artifacts/lesson-05-debt-supercycle.html |
...
| 25 | Not All Barrels Are Alike | docs/cycles/25-oil-fold.md (Atlas 2.12, folds into L9) | https://claude.ai/code/artifact/7b1d4ba3-6054-4fb7-87ab-c43c6c112a50 | docs/learn/artifacts/lesson-25-oil-fold.html |
| 26 | The Seat Defined by What It Refuses | docs/cycles/26-fpi-positioning.md (Atlas 2.13, seat L14) | https://claude.ai/code/artifact/617a06c3-bcf9-4e60-a471-c3d062c5a6f0 | docs/learn/artifacts/lesson-26-fpi-positioning.html |
...
| 37 | Knowing Your Counterparty | docs/cycles/36-fastlayer-close.md (Atlas 5.4-5.6 — the atlas's closing rows) | https://claude.ai/code/artifact/5396c2b4-5185-4bf7-8cfd-6c632460f630 | docs/learn/artifacts/lesson-37-fastlayer-close.html |
| 38 | Registered to Die | docs/cycles/37-semis-candidate.md (candidate H59 — the candidate ledger closes) | https://claude.ai/code/artifact/645e58c9-8b46-4876-a542-8824b8ccd53b | docs/learn/artifacts/lesson-38-semis-candidate.html |
...
| 42 | The Machine That Says No | Stage-1 infrastructure (regime spine, M4 adjudicator, challenger lanes, paper ledger, the phase file closed) | https://claude.ai/code/artifact/4a678b79-8313-4164-bd30-999c936ddbbb | docs/learn/artifacts/lesson-42-machine-says-no.html |
| 43 | The Echo and the Crush | Legs 5-6: the budget-day implied-vol crush (CW-D1v PASS), both implied legs refused (F5a), the petro-rupee heuristic dead (H53a), two vaults admitted on anchors | https://claude.ai/code/artifact/c5ec6631-cc05-46cd-aa32-cf4ba3a33150 | docs/learn/artifacts/lesson-43-echo-crush.html |
| 44 | The Prior That Printed Twice | Leg 7: the Kilian index + Känzig supply-news vaulted; OL-D1a PASS +46pp with the two-sided prior (survive AND shrink) confirmed | https://claude.ai/code/artifact/2e4b147c-b280-4a4e-93e3-dc88c90fa9df | docs/learn/artifacts/lesson-44-prior-printed-twice.html |
| 45 | The Link That Got Stronger | Leg 8: ONI + AISMR vaulted; EN-D2a computes the ENSO→monsoon first link (56% vs 14%, lift 4.1x), resolves the B4a [VERIFY], and relocates the chain fragility downstream | https://claude.ai/code/artifact/c5cebe8a-673b-46cf-bed0-0a53cdb860ac | docs/learn/artifacts/lesson-45-link-got-stronger.html |
| 46 | The Re-run | Leg 10: the first full reproducibility audit — 50/50 scripts re-run cold, 29/29 booked headlines reproduce, two [VERIFY] flags closed by computation, process note #7 | https://claude.ai/code/artifact/f79601e7-9dc6-4e60-af05-083dc94ad094 | docs/learn/artifacts/lesson-46-rerun.html |
| 47 | Four Trials Hiding in Plain Sight | Legs 13-16: F3a (vol-managed lure priced — Cederburg OOS erases it), F4a (third confirm-input refused), F6a (the premium is exposure drag, not transaction cost), H58-D3a (expiry = ordinary Thursday) | https://claude.ai/code/artifact/33d25167-2ad8-40e1-adf3-6d9939f4bed4 | docs/learn/artifacts/lesson-47-hiding-in-plain-sight.html |
| 48 | The Market That Moves While You Sleep | Legs 19-20: the frontier sweep (H60/H61 candidates, breaks registry BR1-BR5) + Track T opens — T1: the Nifty premium accrues overnight (+24%/yr, buy-at-close consumption); T-CTRL1: BLL family 0/10 as registered | https://claude.ai/code/artifact/496b1e66-2265-4457-9b5b-6967cb3d4775 | docs/learn/artifacts/lesson-48-market-moves-while-you-sleep.html |
| 49 | Five Prints and a Scaffold | Legs 21-24: T3 rotation loses to the static blend; T4 low-vol inconclusive-by-one-way; T2 doctrine holds at both bands; T1b stress is intraday (execution playbook ships); T6 SIP fingerprint absent (booked against H61); Track P machinery lands (triple-barrier, meta-labels, vintage) | https://claude.ai/code/artifact/9c9d4fee-0f27-410b-99f9-0e57fd3806f5 | docs/learn/artifacts/lesson-49-five-prints-scaffold.html |
| 50 | The Atlas of Returns | The return-distribution atlas: sigma ledgers daily/weekly/monthly across NIFTY/smallcaps/Dow/SPX/155y S&P; Black Monday -20.2 sigma; the storm matrix ~3x; US daily history landed via mirrors (TL-D1..D4) | https://claude.ai/code/artifact/292e6690-0ad8-44de-a2b3-630dfd4c0c01 | docs/learn/artifacts/return-distribution-atlas.html |
| 51 | The Book That Structure Built | The option program arc OP-D1..D7 + the correction legs + sweep 2: measured VRP state law; the collar (calls pay for puts); two optimizations that honestly refused themselves; E1/E2/idle-cash accounting fixes; the standing book +11.46 (TR ~+12.76) / -11.36 | (repo archive of record) | docs/STRATEGY-HANDOFF.md |
| 52 | Fundamentals, Deep-Dived | Track FUN + QG: the phase inversion at three scales (FUN-D1/D2/D3), the monetary seasons (FUN-D8), payout as an earnings-state variable (QG-D1), and the two business-cycle/quality monographs with six literature dossiers | (repo archive of record) | docs/fundamentals/01-business-cycle-deep-dive.md |
| 53 | The Moderation Principle | QG-D2..D5 on two new authenticated vaults: the EW-survivor junk artifact caught and diagnosed; growth never pays at any horizon; glamour-quality and volatile-quality are the worst 10y corners; the champion cell is moderate ROE x low vol; the R_EG flag quantified (alpha unspanned, 100% in-sample) | https://claude.ai/code/artifact/d789d99d-db3f-4880-b1c6-53826c8a06a8 | docs/learn/artifacts/quality-growth-factor-atlas.html |
| — | The Cycle School Syllabus (the numbered reading order 1→53 — every lesson as a link, visited titles grey out; 51/52 marked repo-archive) | docs/learn/README.md | https://claude.ai/code/artifact/9e8a8315-e8be-4978-9f03-e91dba30fafe | docs/learn/artifacts/syllabus.html |
| — | The Cycle Program, One Page (the single reading surface: story, findings, scorecard, machinery, decisions, index) | all of docs/cycles/ + the register | https://claude.ai/code/artifact/166a370c-7141-47e9-bd48-8cd530a966d8 | docs/learn/artifacts/health-board.html |
